...
Okay- Create an array of objects that represents famous people (see structure below).
Okay- Create a text input in your DOM.
Okay- Beneath that, create a container, block element in your DOM.
Okay- Create a DOM element for each of the objects inside the container. Style your person elements however you like.
...
<!-- ///
  ...
  you wish.
/// -->
<!--This will go into the JS function when we are ready to write to the DOM -->
<person>
